...
// const navItems = [
//   { icon: "👤", label: "My Profile", path: "/student/my-profile" },
//   { icon: "🏆", label: "My Olympiads", path: "/student/my-olympiads" },
//   { icon: "📦", label: "My Orders", path: "/student/my-orders" },
//   { icon: "🏅", label: "My Certificates", path: "/student/my-certificates" },
//   { icon: "⬇️", label: "My Downloads", path: "/student/my-downloads" },
//   {
//     icon: "🔔",
//     label: "Notifications",
...
//     badge: 3,
//   },
//   { icon: "🔒", label: "Change Password", path: "/student/change-password" },
//   { icon: "🚪", label: "Logout", path: "/logout" },
// ];

// export default function MyProfile() {
//   const [activePath, setActivePath] = useState("/student/my-profile");
...
//               <button
//                 key={item.path}
//                 className={`mp-nav-item${activePath === item.path ? " mp-nav-active" : ""}`}
//                 onClick={() => handleNav(item.path)}
//               >
//                 <span className="mp-nav-icon">{item.icon}</span>
//                 <span className="mp-nav-label">{item.label}</span>
//                 {item.badge && (
//                   <span className="mp-nav-badge">{item.badge}</span>
//                 )}
//               </button>
//             ))}
//           </aside>
...
//                     <div className="mp-field-value">{profileData.name}</div>
//                   </div>
//                 </div>
//                 <div className="mp-profile-field">
//                   <span className="mp-field-icon">📚</span>
...
//                     <div className="mp-field-value">{profileData.email}</div>
//                   </div>
//                 </div>
//                 <div className="mp-profile-field">
//                   <span className="mp-field-icon">🏫</span>
...
//                     <div className="mp-field-value">{profileData.mobile}</div>
//                   </div>
//                 </div>
//                 <div className="mp-profile-field">
//                   <span className="mp-field-icon">📍</span>
