        ...
        <div className="practice-paper-sheet">
          ...
          <div className="paper-header">
            {/* <div className="paper-logo">
              <span className="paper-logo-icon">
                <FaGraduationCap />
              </span>
              <div>
                <p className="paper-logo-title">MIND WEAVER</p>
                <p className="paper-logo-subtitle">FOUNDATION</p>
              </div>
            </div> */}
...
export default PracticePaperDetails;
