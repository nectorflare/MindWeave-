...
const defaultSyllabus = {
  ...
  description:
    "The syllabus for Class VIII Olympiad exams is designed to build a strong foundation in language skills and reasoning abilities to help students prepare effectively.",
  sections: [
    {
      id: "A",
      title: "Grammar",
      ...
      topics: [
        ...
        { no: 4, title: "Determiners", // desc: "Action words and helping verbs." 
        },
        {
          no: 5,
          title: "Conditionals",
    ...
    },
    {
      ...
      topics: [
        ...
        {
          no: 12,
          title: "Informative and persuasive texts",
    ...
    },
    {
      ...
      topics: [
        {
          no: 16,
          title: "Critical verbal reasoning",
          // desc: "Identifying the odd one from given options.",
        },
        {
          no: 17,
