...
//           <span className="sp-breadcrumb-home" onClick={() => handleNav("/")}>
//             Home
//           </span>
//           <span className="sp-breadcrumb-sep"> &gt; </span>
//           <span className="sp-breadcrumb-current">School Profile</span>
//         </div>
...
//                   <span className="sp-field-icon">📋</span>
//                   <div>
//                     <div className="sp-field-label">Affiliation</div>
//                     <div className="sp-field-value">
...
//                     <div className="sp-field-value">{profileData.email}</div>
//                   </div>
//                 </div>
//                 <div className="sp-profile-field">
//                   <span className="sp-field-icon">👤</span>
...
//                   </div>
//                 </div>
//                 <div className="sp-profile-field sp-edit-col">
//                   <button
...
//                     <div className="sp-field-value">{profileData.mobile}</div>
//                   </div>
//                 </div>
//                 <div className="sp-profile-field">
//                   <span className="sp-field-icon">📍</span>
//                   <div>
//                     <div className="sp-field-label">City / State</div>
//                     <div className="sp-field-value">
...
//                   </div>
//                   <div className="sp-addr-phone">+91 98765 43210</div>
//                 </div>

//                 {/* Address 2 */}
//                 <div className="sp-addr-card">
//                   <div className="sp-addr-header">
//                     <span className="sp-addr-label">Branch</span>
//                     <div className="sp-addr-actions">
//                       <button
//                         className="sp-addr-icon-btn"
//                         onClick={() => alert("Edit Branch address")}
//                       >
//                         ✏️
//                       </button>
//                       <button
//                         className="sp-addr-icon-btn sp-addr-del"
//                         onClick={() => alert("Delete Branch address")}
//                       >
//                         🗑️
//                       </button>
//                     </div>
